...
describe('Component: Button', () => {
  describe('buttons', () => {
    ...
    describe('disabled prop', () => {
      ...
      it('should render button as not disabled when disabled prop is false', () => {
  ...
  describe('className prop', () => {
    const baseClassName = 'form__submit button';
  ...
  describe('style prop', () => {
    it('should apply the "style" attribute if the corresponding prop is present', () => {
      const expectedStyleAttributeValue = 'margin-top: 20px; min-width: 200px;';

      render(<Button style={{ marginTop: '20px', minWidth: '200px' }}>Button</Button>);

      expect(screen.getByRole('button')).toHaveStyle(expectedStyleAttributeValue);
    });
  });
